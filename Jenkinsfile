  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t 0914818516/restaurant-listing-service:${VERSION} .'
          sh 'docker push 0914818516/restaurant-listing-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: 0914818516\\/restaurant-listing-service:${VERSION}/" aws/restaurant-manifest.yml
        '''
